// management-wechat-crm 自动替换脚本（生成后需人工审查再执行）
const fs = require('fs');
const path = require('path');

const replacements = [
  // CSS 链接替换
  { file: "index.html", line: 10, from: "//res.winbaoxian.com/ali-iconfont/font_428664_79kd0g7h613.css", to: "iconfont_merged.css", type: "css_link" },
  // 图标类名替换
  { file: "src/views/detail/components/common/add-label.vue", line: 41, from: "icon-close_line_b", to: "icon-close_line_b_v2", type: "icon_class" },
];
