// fed-toolset 自动替换脚本（生成后需人工审查再执行）
const fs = require('fs');
const path = require('path');

const replacements = [
  // CSS 链接替换
  { file: "client/src/common/iconfont-list/iconfont-list.vue", line: 72, from: "./iconfont-list.scss", to: "iconfont_merged.css", type: "css_link" },
  { file: "client/src/pages/iconfont/iconfont.vue", line: 22, from: "./iconfont.scss", to: "iconfont_merged.css", type: "css_link" },
  // 图标类名替换
